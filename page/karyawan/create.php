      ...
      <form role="form" method="post">
        <div class="box-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control input-lg" id="exampleInputEmail1" placeholder="Masukan NIP" name="NIP" <?php if (isset($_GET['nip'])) {
                                                                                                                            echo "value='" . $_GET['nip'] . "'";
                                                                                                                          } else {
                                                                                                                            echo "";
                                                                                                                          } ?> required>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control input-lg" id="exampleInputEmail1" placeholder="Masukan Nama karyawan" name="karyawan" <?php if (isset($_GET['nama'])) {
                                                                                                                                            echo "value='" . $_GET['nama'] . "'";
                                                                                                                                          } else {
                                                                                                                                            echo "";
                                                                                                                                          } ?> required>
          </div>
          <div class="form-group">
            ...
            <select class="form-control custom-select input-lg" name="JK">
              ...
              <option value="Pria" <?php if ($_GET['JK'] == "Pria") {
                                      echo "selected";
                                    } else {
                                      echo "";
                                    } ?>>Pria</option>
              <option value="Wanita" <?php if ($_GET['JK'] == "Wanita") {
                                        echo "selected";
                                      } else {
                                        echo "";
                                      } ?>>Wanita</option>
